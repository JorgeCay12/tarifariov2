...
{
    public class ReporteTarifariosDiversosController : Controller
    {
        // GET: ReporteTarifariosDiversos
        ...
        public JsonResult Json()
        {
            ...
            string ctipo = Request["ctipo"]; //0 es derecho de admision pregrado // 2 es derecho de admision posgrado // 3 tarifarios diversos
